...
3. Manage dependencies, preferably in a "[packrat](https://rstudio.github.io/packrat/)" repo. A packrat project has its own private package library. Any packages you install from inside a packrat project are only available to that project; and packages you install outside of the project are not available to the project.
