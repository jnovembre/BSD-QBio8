...
graphics: yes
endnote: no
thanks: "This document is included as part of the workshop packet for the BSD qBio Bootcamp, University of Chicago, 2021. **Current version**: `r format(Sys.time(), '%B %d, %Y')`."
---
